'''
This script loads the plain text of Moby Dick, splits it into chunks,
...
# Configuration
SOURCE_TEXT_PATH = os.path.join("books", "moby_dick.txt")
...
def process_and_store_text():
    ...
    if not os.path.exists(SOURCE_TEXT_PATH):
        ...
        print("Please ensure 'fetch_moby_dick.py' has been run successfully.")
        return
